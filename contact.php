...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Jena Blood Bank &amp; <br>Jena Medical Trust, <br>
					Bhubaneswar,Retanga,<br>
					Pin-752054.<br>
					Khordha,Odisha.
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 7008980995</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="#" >Online blood donation@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: 24*7</p>
				<p><i class="fa fa-globe"></i> 
                    <abbr title="Website">W</abbr>: <a href="index.php">www.Online blood donation system.com</a></p>
